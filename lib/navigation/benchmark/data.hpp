...
struct Data {
  ...
  std::map<core::TimePoint, core::CombinedRawAccelerometerData> acceleration_data_by_time;
  ...
  std::optional<core::CombinedRawAccelerometerData> getAccelerationDataAt(
...
class DataBuilder {
 public:
  ...
  core::Result addEncoderData(const core::RawEncoderData &encoder_data);
  core::Result addUniformEncoderData(const std::uint64_t nanos_since_epoch,
                                     const std::uint32_t total_num_revolutions);
  core::Result addAccelerationData(const core::CombinedRawAccelerometerData &acceleration_data);
  core::Result addUniformAccelerationData(const std::uint64_t nanos_since_epoch,
                                          const core::RawAcceleration &raw_acceleration);
  core::Result addKeyenceData(const core::RawKeyenceData &keyence_data);
